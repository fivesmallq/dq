...
public class Rs {
    ...
    /**
     * Apply an "equal" constraint to the named property. If the value is null,
     * instead apply "is null".
     *
     * @param propertyName
     * @param value
     * @return Criterion
    ...
    /**
     * Apply a "not equal" constraint to the named property. If the value is
     * null, instead apply "is not null".
     *
     * @param propertyName
     * @param value
     * @return Criterion
     ...
     * @return
     */
    public static DynamicConjunction dynamicAnd(Criterion... predicates) {
        DynamicConjunction conjunction = dynamicConjunction();
        if (predicates != null) {
            for (Criterion predicate : predicates) {
                conjunction.add(predicate);
            }
     ...
     * @return
     */
    public static DynamicDisjunction dynamicOr(Criterion... predicates) {
        DynamicDisjunction disjunction = dynamicDisjunction();
        if (predicates != null) {
            for (Criterion predicate : predicates) {
    ...
    /**
     * Apply a constraint expressed in SQL, with the given JDBC parameter. Any
     * occurrences of <tt>{alias}</tt> will be replaced by the table alias.
     *
     * @param sql
     * @param value
    ...
    public static Criterion sqlRestriction(String sql) {
        return new SQLCriterion(sql, ArrayUtils.EMPTY_OBJECT_ARRAY);
    }
     ...
     * @return
     */
    public static DynamicConjunction dynamicConjunction() {
        return new DynamicConjunction();
    }
     ...
     * @return
     */
    public static DynamicDisjunction dynamicDisjunction() {
        return new DynamicDisjunction();
    }
